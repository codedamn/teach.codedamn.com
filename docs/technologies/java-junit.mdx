...
5. Providing custom input to stdin
6. Reading the output from stdout
7. Setting up evaluation script
...
In order to provide custom inputs to the program, you can use the `provideInput()` method that accepts String data and provides input to the program when it requires.
