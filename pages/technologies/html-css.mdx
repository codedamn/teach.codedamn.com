...
![Setting a container image](../../public/images/lab-container-image.png)
...
This would include everything codedamn has to offer - a terminal at the bottom, an IDE in center (powered by Monaco on desktops, and CodeMirror on mobile phones), and a browser preview of (ideally) what user is working on. This is best for frontend/full-stack projects.
...
![Lab default repository](../../public/images/lab-default-repo.png)

**Important note:** For HTML and CSS playground, we recommend you to fork the following repository and use it as a starter template: [HTML playground starter - codedamn](https://github.com/codedamn-classrooms/html-playground-starter)
...
![](../../public/images/lab-add-challenges.png)
...
![](../../public/images/lab-edit-test.png)
...
![](../../public/images/lab-test-file-dropdown.png)
...
-   We then visit `http://localhost:1337`. At this point, I would highly recommend you to read [How port mapping works for codedamn playgrounds](/port-mapping), if you haven't yet.
...
![](../../public/images/playground-tests.png)
...
![](../../public/images/playground-tests-2.png)
...
![](../../public/images/lab-run-tests.png)
...
![](../../public/images/lab-test-command.png)
...
![](../../public/images/lab-verified-solutions.png)
...
![](../../public/images/playground-verified-solution.png)
