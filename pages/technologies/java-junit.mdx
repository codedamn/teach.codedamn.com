...
5. [Setting up evaluation script](#step-7---evaluation-script)
...
class TestFile {
    ...
    public static void doCleanup() {
        // Runs after all the test cases are executed
    }
    ...
    public void test1() {
        try {
            ...
            */
            ...
            assertEquals(returnedOutput, "Hello World"); // Check for the expected output
